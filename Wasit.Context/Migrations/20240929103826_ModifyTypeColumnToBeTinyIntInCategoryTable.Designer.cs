...
namespace Wasit.Context.Migrations
{
    ...
    [Migration("20240929103826_ModifyTypeColumnToBeTinyIntInCategoryTable")]
    partial class ModifyTypeColumnToBeTinyIntInCategoryTable
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Wasit.Core.Entities.BrokerEstateSection.P4AddBrockerEstate", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
                    ...
                    b.ToTable("P4AddBrockerEstates");
                });

            modelBuilder.Entity("Wasit.Core.Entities.BrokerEstateSection.S4AddBrockerEstate", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
                    ...
                    b.Property<int>("MaxEstatesCount")
                        .HasColumnType("int");
                    ...
                    b.Property<int>("RemainingEstatesCount")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Wasit.Core.Entities.DeveloperPackagesSection.P4UpgradeDevAccount", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
                    ...
                    b.ToTable("P4UpgradeDevAccounts");
                });

            modelBuilder.Entity("Wasit.Core.Entities.DeveloperPackagesSection.S4UpgradeDevAccount", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
                    ...
                    b.ToTable("S4UpgradeDevAccounts");
                });
            ...
            modelBuilder.Entity("Wasit.Core.Entities.EstateCategories.CategoryEstateType", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Wasit.Core.Entities.EstateServiceSection.P4ShowEstateService", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
                    ...
                    b.ToTable("P4ShowEstateServices");
                });

            modelBuilder.Entity("Wasit.Core.Entities.EstateServiceSection.S4ShowEstateService", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
                    ...
                    b.ToTable("S4ShowEstateServices");
                });
            ...
            modelBuilder.Entity("Wasit.Core.Entities.UserTables.ApplicationDbUser", b =>
                {
                    ...
                    b.Navigation("S4AddBrockerEstates");

                    b.Navigation("S4AddPriceToEstates");

                    b.Navigation("S4ShowEstateServices");

                    b.Navigation("S4UpgradeDevAccounts");
