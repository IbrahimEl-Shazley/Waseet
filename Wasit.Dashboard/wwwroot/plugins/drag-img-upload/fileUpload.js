        ...
        return this.each(function () {
            ...
            var fileDivContent = `
                <label for="${fileUploadId}" class="file-upload">
                    <div>
                        <img src="/imgs/file-storage.png">
                        <p class="dark-blue">برجاء رفع صورة الاعلان او سحبها الى هنا</p>
                    </div>
                    <input type="file" id="${fileUploadId}" name=[] hidden />
                </label>
            `;
                    ...
                    $.each(files, function (index, file) {
                        ...
                        tableBody.append(`
                            <tr>
                                ...
                                <td>${fileSize}</td>
                                <td>${fileType}</td>
                                <td><button type="button" class="deleteBtn"><i class="fa-regular fa-trash-can text-white"></i></button></td>
                            </tr>
                        `);
                    });
