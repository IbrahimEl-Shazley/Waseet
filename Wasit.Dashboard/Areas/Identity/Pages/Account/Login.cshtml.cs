...
namespace Wasit.Dashboard.Areas.Identity.Pages.Account
{
    public class LoginModel : PageModel
    {
        ...
        public LoginModel(SignInManager<ApplicationDbUser> signInManager, ILogger<LoginModel> logger)
        {
        ...
        public class InputModel
        {
            ...
            [RegularExpression(RegEx.Email, ErrorMessage = "يرجي ادخال بريد الكتروني صحيح")]
