...
namespace Wasit.Services.MapperConfig
{
    ...
    {
        public void MapEntertainmentEstates(ICurrentUserService currentUser)
        {
            CreateMap<CreateEntertainmentEstateDto, EntertainmentEstate>()
            ...
            CreateMap<IFormFile, EntertainmentEstateImage>()
                .ForMember(dest => dest.Image, opt => opt.MapFrom(src => IOHelper.Upload(src, (int)FileName.Estates)));

            CreateMap<SpecificationKeyValueDto, EntertainmentEstateSpecificationValue>()
            ...
            CreateMap<EntertainmentEstate, EntertainmentEstateInfoDto>()
            ...
            CreateMap<UpdateEntertainmentEstateDto, EntertainmentEstate>()
              .ForMember(dest => dest.EstateName, opt => opt.MapFrom(src => src.NameAr))
              .ForMember(dest => dest.EstateDescription, opt => opt.MapFrom(src => src.Description))
              .ForMember(dest => dest.Developable, opt => opt.MapFrom(src => src.IsDevelopable))
              .ForMember(dest => dest.DayRentPrice, opt => opt.MapFrom(src => src.Price))
            ...
            CreateMap<EntertainmentRequest, EntertainmentRentRequestDto>()
                .ForMember(dest => dest.UserName, opt => opt.MapFrom(src => src.User.User_Name))
                .ForMember(dest => dest.Status, opt => opt
                    .MapFrom(src => string.Empty));
            //.MapFrom(src => EnumHelper.EntertainmentRentRequestStatus(src.Status, currentUser.Language)));
            CreateMap<PageDTO<EntertainmentRequest>, PageDTO<EntertainmentRentRequestDto>>()
                 .ForMember(dest => dest.Data, opt => opt.MapFrom(src => src.Data));

            CreateMap<EntertainmentRequest, EntertainmentRentRequestInfoDto>()
